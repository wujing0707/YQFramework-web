...
<body style="overflow:auto;">
		...
		<table cellspacing="0" cellpadding="0" class="tablelist tablelist0"
			...
			<tbody>
				<tr>
					...
					onclick="exportpdf();">导出pdf报告</a>--></th>
				</tr>
				<tr>
					<th width = "10%">企业名称</th>
	...
	<div id="usual1" class="usual mt10">
			...
			<table  cellpadding="0" class="tablelist tablelist0" bordercolor="black" border="1" cellspacing="0" style="table-layout:fixed;word-break:break-all;word-wrap:break-word;">
				<tr>
					<th colspan="5" style="text-align: center;">失信行为信息</th>
				</tr>
			</table>
									...
									<tbody>
										<tr>
											...
											<c:forEach items="${deptInfo.columnName}" var="titleInfo"
												varStatus="status">
												<th style="width:120px;word-wrap:break-word;">${titleInfo}</th>
											</c:forEach>
										</tr>
										<c:choose>
