...
<body style="overflow:auto;">
	...
	<div style="width:90%;margin:0 auto;text-align:center">  
	 <div id="div_print"> 
	   <p>
       	<font style="font-size:30px;">${baseInfo.企业名称}</font><br /><br />
	      ...
	      <table bordercolor="black" border="1" cellspacing="1" style="table-layout:fixed;word-break:break-all word-wrap:break-word;width:100%;text-align:center;margin-top:30px;margin:0  auto;">
			    	<tr height="60px">
			      	...
			      	<tr height="60px">
			    		<td width="40%" style="font-size:18px">${baseInfo.企业名称}</td>
			    		<td width="20%" style="font-size:18px">${baseInfo.组织机构代码}</td>
			    		<td width="20%" style="font-size:18px">${baseInfo.企业注册号}</td>
			    		<td width="20%" style="font-size:18px">${baseInfo.法定代表人}</td>
			    	</tr>  	
	      </table>
	      <div class="clear"></div>
	      ...
	      <div>
 			...
 			<div class="clear"></div>
	      	<div style="float:left;font-size:20px">
				<span style="float:left;font-size:20px">1、在信用核查码有效期内，被授权企业可以通过“企业通”在线核查授权企业的信用核查结果信息。</span><br />
	     ...
	     <div style="margin-top:50px">
			...
			<a id="" class="easyui-linkbutton l-btn l-btn-small" onclick="window.history.back()" iconcls="icon-cancel" href="javascript:void(0)" group="">
			    <span class="l-btn-left l-btn-icon-left">取消</span>
			</a>	     
		...
		<form id="checkCodeForm" method="post" action="<%=basePath%>creditVerification/creditsaveCheckCode.action">
