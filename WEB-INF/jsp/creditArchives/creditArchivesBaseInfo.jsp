...
$.extend($.fn.datagrid.methods, {
				...
				.datagrid(
						{
							...
							toolbar : '#tb',
							iconCls : 'icon-user',
							url : "<%=basePath%>creditArchives/getCompanyCreditArchivesactionList.action",
							loadMsg : "载入中...请等待.",
	...
	function showQueryTip(zzjgdm,gszch,qymc) {
		window.open("<%=basePath%>creditArchives/getCompanyCreditArchivesDetailInfo.action?zzjgdm="+zzjgdm+"&gszch="+gszch+"&qymc="+qymc);
		//window.location.href = "<%=basePath%>creditArchives/getCompanyCreditArchivesDetailInfo.action?zzjgdm="+zzjgdm+"&gszch="+gszch+"&qymc="+qymc;
	}
