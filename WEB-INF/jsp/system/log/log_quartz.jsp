...
<body>
	...
	<table id="logGrid"  class="easyui-datagrid" 
        ...
        <thead>
            <tr>
                ...
                <th field="QUARTZ_NAME" width="40" align="left">定时器名称</th>
                <th field="START_TIME" width="30" align="left">开始执行时间</th>
                <th field="END_TIME" width="30" align="left">结束执行时间</th>
            </tr>
        </thead>
    </table>
    </div>
    <div id="tb" style="padding:5px;height:auto">
        <div style="margin-bottom:5px">
           	<label>定时器名称：</label>
           	<input id="quartzName" class="easyui-textbox" style="width:80px" data-options="prompt: ''"> 
           	<label>开始时间：</label>
	...
	if((sd != '' && sd != null && sd != 'undefined') && (ed != '' && ed != null && ed != 'undefined'))
	{
		...
		*/
        function conditionSearch(){
           ...
           queryParams["quartzName"] = quartzName;
        ...
        function conditionReset(){
    		...
    		jQuery("#quartzName").textbox('setValue',"");
    	...
    	function conditionLogExport(){
    		...
    		var quartzName = jQuery("#quartzName").textbox('getValue');
    		var startDate = jQuery("#conditionStartDate").datebox('getValue');
        	var endDate = jQuery("#conditionEndDate").datebox('getValue');
           ...
           var url ="logExportToTxt.action?quartzName=" + encodeURI(encodeURI(quartzName)) + "&startDate=" + startDate + "&endDate=" + endDate;
           window.open(url);
