...
<div class="formbody">
  ...
  <form:form action="saveComplain.action" commandName="complain" id="cform"  method="POST" >
    <li>
      <label>申诉人姓名</label>
      <form:input path="name" class="dfinput" maxlength="25" infos="申诉人姓名"/>
    </li>
    <li>
      <label><b>*</b>申诉人电话</label>
      <form:input path="phoneNumber" class="dfinput must" maxlength="25" infos="申诉人电话"/>
    </li>
    <li>
      <label><b>*</b>身份证号码</label>
      <form:input path="idNumber" class="dfinput" disabled="true" maxlength="25"/>
      <form:hidden path="idNumber"/>
    </li>
    
    <li>
      <label><b>*</b>申诉人Email</label>
       <form:input path="email" class="dfinput must" maxlength="25" infos="申诉人Email"/>
    </li>
    <li>
      <label><b>*</b>申诉人地址</label>
      <form:input path="address" class="dfinput must" maxlength="25" infos= "申诉人地址"/>
    </li>
    <li>
      <label><b>*</b>申诉主题</label>
      <form:input path="subject" class="dfinput must" maxlength="25" infos="申诉主题" id="subjectID"/>
    </li>
    <li>
      <label><b>*</b>申诉内容</label>
      <form:textarea path="content" rows="4" cols="20" class="textinput must" onchange="this.value=this.value.substring(0, 300)" onkeydown="this.value=this.value.substring(0, 300)" onkeyup="this.value=this.value.substring(0, 300)" maxlength="300" style="overflow-y:auto" infos="申诉内容"/>
		...
		$("#submitComplain").bind("click",function(){
			...
			$.ajax({
                ...
                success: function(data) {
                    ...
                    var check = $('#check').val();
                    if (check == 'Y') {
                    	window.location.href = "${pageContext.request.contextPath}/complain/editComplain.action?UTYPE=P&CHECK=Y";
                    } else {
                    	history.go(-1);
                    }
                }
