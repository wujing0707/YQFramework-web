  ...
  <form:form action="saveComplain.action" commandName="complain" id="cform"  method="POST" >
      ...
      <div class="in">
      	<ul id="files">
      		<c:forEach items="${cfiles }" var="file">
      			<li>
      			<!-- <a href="javascript:showfile('/${file.path}')">${file.fileName }</a> -->
    ...
    <c:if test="${hi['show'] }">
    	...
    	<c:if test="${hi['type'] eq 'DHANDLE' }">
    	  ...
    	  <textarea rows="6" cols="20" style="overflow-y:auto;color:#ADADAD" class="textinput" readonly="true">${hi['content']}</textarea>
    	</li>
